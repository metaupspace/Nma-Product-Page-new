...
import { submitWaitlistEntry, checkEmailExists } from '@/services/waitListService';
    ...
    const onSubmit = async (data: FormData) => {
        ...
        try {
            ...
            if (result) {
                setSubmitStatus({
                    type: 'success',
                    message: 'Thank you! You\'ve been successfully added to our waitlist. We\'ll be in touch soon.'
                });
