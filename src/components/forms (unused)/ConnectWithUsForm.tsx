...
import { submitConnectRequest, checkEmailExists } from '@/services/connectWithUsService';
    ...
    const onSubmit = async (data: FormData) => {
        ...
        try {
            ...
            if (emailExists) {
                setSubmitStatus({
                    type: 'error',
                    message: 'This email has already submitted a connection request. We\'ll be in touch soon!'
                });
            ...
            // Submit to Strapi
            const result = await submitConnectRequest({
            ...
            if (result) {
                setSubmitStatus({
                    type: 'success',
                    message: 'Thank you for connecting with us! We\'ve received your message and our team will get back to you within 24 hours.'
                });
